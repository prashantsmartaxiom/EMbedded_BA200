/***********************************************************************************************************************
File Name: mpXXXX_driver.h
Global Data:
    Name                    Type                        Description
    ----------------------- --------------------------- ------------------------------------------------------------

Description:
    Header file of mpXXXX_driver.c.
========================================================================================================================
History:
...
#ifndef _MPXXXX_DRIVER_H_
#define _MPXXXX_DRIVER_H_
...
typedef struct
{    
    uint16_t  Shade_01_outputPower;
    uint16_t  Shade_02_outputPower;
    uint16_t  Shade_03_outputPower;
    uint16_t  Shade_04_outputPower;
    uint16_t  EXP_LED_01_outputPower;
    uint16_t  EXP_LED_02_outputPower;
    uint16_t  EXP_LED_03_outputPower;
    uint16_t  EXP_LED_04_outputPower;
    uint16_t  EXP_LED_05_outputPower;
    uint16_t  EXP_LED_06_outputPower;
    uint16_t  EXP_LED_07_outputPower;
    uint16_t  EXP_LED_08_outputPower;
} Mp5920RegisterMap;
...
typedef struct
{
    ...
    uint16_t  IO_04_VOUT;
    uint16_t  IO_04_IOUT;
    uint16_t  FAN_CH1_VOUT;
    uint16_t  FAN_CH1_IOUT;
    uint16_t  FAN_CH2_VOUT;
    uint16_t  FAN_CH2_IOUT;
    uint16_t  RS485_01_VOUT;
    uint16_t  RS485_01_IOUT;
    uint16_t  RS485_02_VOUT;
    uint16_t  RS485_02_IOUT;
    uint16_t  RS485_03_VOUT;
    uint16_t  RS485_03_IOUT;
    uint16_t  RS485_04_VOUT;
    uint16_t  RS485_04_IOUT;
} Mp8880aRegisterMap;
